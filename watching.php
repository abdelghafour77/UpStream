                ...
                <div class="details-buttons">
                  <div class="row d-flex align-items-center">
                    <div class="col-6 col-xl mb-xl-0 mb-3">
                      <a href="https://excellencetheme.com/templates/avastream/watch-movie.html" class="btn d-block hvr-sweep-to-right" tabindex="0"><i class="icofont-ui-play mr-2" aria-hidden="true"></i>Play</a>
                    </div>
                    <!-- Col End -->
                    <div class="col-6 col-xl mb-xl-0 mb-3">
                      <a href="https://excellencetheme.com/templates/avastream/watch-movie.html" class="btn d-block hvr-sweep-to-right" tabindex="0"><i class="icofont-plus mr-2" aria-hidden="true"></i>MY List</a>
                    </div>
                    <!-- Col End -->
                    <div class="col-6 col-xl mb-xl-0 mb-3">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/01(1).jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      ...
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><i class="fas fa-plus"></i></a>
                      </li>
                      <li>
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/02.jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html"><i class="fas fa-play"></i></a>
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/03.jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html"><i class="fas fa-play"></i></a>
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/04.jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html"><i class="fas fa-play"></i></a>
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/05.jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html"><i class="fas fa-play"></i></a>
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
              <div class="video-block">
                <div class="video-thumb position-relative thumb-overlay">
                  <a href="https://excellencetheme.com/templates/avastream/watch-movie.html#"><img class="img-fluid" src="./img/06.jpg" alt="" /></a>
                  <div class="box-content">
                    <ul class="icon">
                      <li>
                        <a href="https://excellencetheme.com/templates/avastream/watch-movie.html"><i class="fas fa-play"></i></a>
